...
3. User testet manuell auf TrueNAS/System
...
ssh siggiaze@hera "docker logs cloudtouch -f"

# Container Shell
ssh siggiaze@hera "docker exec -it cloudtouch /bin/bash"

# SSDP Discovery testen
ssh siggiaze@hera "docker exec cloudtouch python -m backend.adapters.ssdp_discovery"
```
