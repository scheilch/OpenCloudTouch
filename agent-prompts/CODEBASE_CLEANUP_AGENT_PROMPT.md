...
- TRUENAS-DEPLOY.md (60 lines, TrueNAS-specific)

AFTER (AUTONOMOUS):
- docs/DEPLOYMENT.md (80 lines, comprehensive, includes all scenarios)
- TRUENAS-DEPLOY.md (kept, references DEPLOYMENT.md for common steps)
...
const allowedDomains = ['cloudtouch.local']
...
- TrueNAS Deployment (deploy-to-truenas.ps1): <5min
...
# TrueNAS deployment
Measure-Command { .\deployment\deploy-to-truenas.ps1 }
...
- TrueNAS Deploy: [X]s (Target: <300s)
...
| `deployment/deploy-local.ps1` | ⚠️ Redundant | **CONSOLIDATE** | Merge into `deploy-to-truenas.ps1` |
...
- `docker-compose.yml`
- Deployment scripts (`deploy-to-truenas.ps1`)
