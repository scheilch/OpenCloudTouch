...
2. Finde `scheilch/soundtouch-bridge`
...
2. Gehe zu deinem GitHub Repo:
   ```
   https://github.com/scheilch/soundtouch-bridge/settings/secrets/actions
   ```
...
1. Gehe zu: https://app.codecov.io/gh/scheilch/soundtouch-bridge
2. Du siehst jetzt:
...
```markdown
[![codecov](https://codecov.io/gh/scheilch/soundtouch-bridge/branch/main/graph/badge.svg)](https://codecov.io/gh/scheilch/soundtouch-bridge)
```
