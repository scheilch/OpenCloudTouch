...
*   Hilfe-Seite (Setup/Fehlerdiagnose, IP/Version herausfinden, WLAN-Einrichtung).
...
*   Optional: sp├ñter 'RasPi Image' (Debian Lite + Docker + Autostart + mDNS 'soundtouch.local').
