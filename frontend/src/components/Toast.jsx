...
export default function Toast({ message, type = 'info', duration = 5000, onClose }) {
  ...
  return (
    <div className={`toast toast-${type} ${isVisible ? 'toast-visible' : 'toast-hidden'}`} data-test="toast-notification">
      <div className="toast-icon">
        {icons[type]}
      </div>
      <div className="toast-content">
        <p className="toast-message" data-test="toast-message">{message}</p>
      </div>
      <button 
