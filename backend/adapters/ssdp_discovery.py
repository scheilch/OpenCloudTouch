...
class SSDPDiscovery:
    ...
    async def _fetch_device_descriptions(self, locations: list[str]) -> Dict[str, Dict[str, str]]:
        """
    ...
    async def _fetch_and_parse_device(
        ...
        try:
            ...
            # Extract device info
            friendly_name = self._find_xml_text(root, ".//friendlyName") or "Unknown Bose Device"
