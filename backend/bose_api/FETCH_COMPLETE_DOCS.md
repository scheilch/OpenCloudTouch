...
Device: SoundTouch 30 - ST30_Wohnzimmer (192.168.178.78)
======================================================================
...
Device: SoundTouch 300 - ST300_TV (192.168.178.83)
======================================================================
...
```powershell
$devices = @(@{Name='ST300_TV'; IP='192.168.178.83'; ID='83'; Model='SoundTouch 300'})
.\fetch-api-schemas-complete.ps1
```
...
- Check device is online: `ping 192.168.178.78`
- Verify port 8090 is open: `Test-NetConnection -ComputerName 192.168.178.78 -Port 8090`
- Check firewall settings on TrueNAS/host
