...
from soundtouch_bridge.adapters.bosesoundtouch_adapter import BoseSoundTouchDiscoveryAdapter, BoseSoundTouchClientAdapter
from soundtouch_bridge.discovery.manual import ManualDiscovery
...
async def get_device_capabilities_endpoint(
    ...
    """
    from soundtouch_bridge.adapters.capability_detection import (
