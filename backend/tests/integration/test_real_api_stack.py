...
from cloudtouch.devices.api.routes import get_device_repo, get_settings_repo
...
async def real_api_client(real_db):
    ...
    with patch("cloudtouch.main.device_repo", device_repo), \
         patch("cloudtouch.main.settings_repo", settings_repo):
