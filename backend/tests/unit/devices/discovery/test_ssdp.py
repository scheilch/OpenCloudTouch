...
async def test_fetch_device_descriptions_bose_device():
    ...
    <root xmlns="urn:schemas-upnp-org:device-1-0">
        <device>
            ...
            <serialNumber>A81B6A292399</serialNumber>
        </device>
    </root>"""
    mock_response.raise_for_status = MagicMock()
    ...
    with patch('httpx.AsyncClient') as mock_client:
        ...
        devices = await discovery._fetch_device_descriptions(['http://192.168.1.100:8091/XD/BO5EBO5E-F00D-F00D-FEED-A81B6A292399.xml'])
